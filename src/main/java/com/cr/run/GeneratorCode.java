...
public class GeneratorCode {
    private static String author ="cr";//作者名称
    private static String outputDir ="D:\\IntelliJ IDEA 2020.1.1\\JavaProject\\vue-admin-sys\\src\\main\\java";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/vue-admin-sys?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="root";//数据库密码
    private static String tablePrefix ="sys_";//数据库表的前缀，如t_user
    private static String [] tables = {"sys_user","sys_role","sys_menu"};   //生成的表
    private static String parentPackage = "com.cr";//顶级包结构
